...
#' predictCFMortality (age = 40.4, male = 1, fvc = 25.7, fev1 = 19.2, fev1LastYear = 20, bcepacia = 1, underweight = 1, nHosp = 6, pancreaticInsufficient = 0, CFRelatedDiabetes = 0, ageAtDiagnosis = 27.2)
