#' Predicting 1- and 2-year risk of death for patients with cystic fibrosis (CF)
...
#' @param CFRelatedDiabetes A binary variables for CF related diabetes
...
predictCFMortality <- function(age, male, fvc, fev1, fev1LastYear, bcepacia, underweight, nHosp, pancreaicInsufficient, CFRelatedDiabetes, ageAtDiagnosis) {
  ...
  osf <- round (s1*s2/100, digits = 2)


  p1 <- paste (" 1-year probability of survival is:",s1)
  p2 <- paste (" 2-year probability of survival is:", s2)
  p3 <- paste (" The overall probability of survival at 2 years is:",osf )
